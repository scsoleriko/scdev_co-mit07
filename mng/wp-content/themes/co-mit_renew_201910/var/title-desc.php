...
<title><?php echo $term_name = single_term_title( '', false ); ?>の研修施設一覧｜CO-MIT(コミット)研修施設検索サイト</title>
<?php if ( $term == 'concent' ): ?>
<meta name="description" content="集中できる環境で研修できる施設が見つかるかも？！研修・合宿施設検索サイト「CO-MIT（コミット）」では、企業研修や新入社員研修、開発合宿、オフサイトミーティング、チームビルディングに最適な研修施設やホテルをご紹介。">
<?php elseif ( $term == 'motivate' ): ?>
<meta name="description" content="モチベーションが上がる環境で研修できる施設が見つかるかも？！研修・合宿施設検索サイト「CO-MIT（コミット）」では、企業研修や新入社員研修、開発合宿、オフサイトミーティング、チームビルディングに最適な研修施設やホテルをご紹介。">
<?php elseif ( $term == 'environment' ): ?>
<meta name="description" content="いつもと違った環境で研修できる施設が見つかるかも？！研修・合宿施設検索サイト「CO-MIT（コミット）」では、企業研修や新入社員研修、開発合宿、オフサイトミーティング、チームビルディングに最適な研修施設やホテルをご紹介。">
<?php elseif ( $term == 'incentive' ): ?>
<meta name="description" content="インセンティブ旅行を兼ねて研修できる施設が見つかるかも？！研修・合宿施設検索サイト「CO-MIT（コミット）」では、企業研修や新入社員研修、開発合宿、オフサイトミーティング、チームビルディングに最適な研修施設やホテルをご紹介。">
<?php endif; ?>
